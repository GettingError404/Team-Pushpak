...
const SocialLink = ({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-secondary hover:text-accent transition-colors group">
...
const ContactPage = () => {
  return (
    ...
    >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                <motion.div className="text-left" variants={itemVariants}>
                    ...
                    <p className="mt-4 text-lg text-secondary/80 leading-relaxed">
                        Have a project idea, a sponsorship opportunity, or interested in joining the team? We'd love to hear from you.
                    </p>
                    <motion.div 
                ...
                >
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" className="mt-1 block w-full bg-slate-800/50 border border-slate-600 rounded-md shadow-sm focus:ring-2 focus:ring-accent focus:border-accent sm:text-sm text-white p-3 transition" />
                    </div>
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-secondary mb-1">Email Address</label>
                        <input type="email" name="email" id="email" className="mt-1 block w-full bg-slate-800/50 border border-slate-600 rounded-md shadow-sm focus:ring-2 focus:ring-accent focus:border-accent sm:text-sm text-white p-3 transition" />
                    </div>
                    <div>
                        <label htmlFor="message" className="block text-sm font-medium text-secondary mb-1">Message</label>
                        <textarea id="message" name="message" rows={4} className="mt-1 block w-full bg-slate-800/50 border border-slate-600 rounded-md shadow-sm focus:ring-2 focus:ring-accent focus:border-accent sm:text-sm text-white p-3 transition"></textarea>
                    </div>
                    <div>
        ...
        <PageNavigation prevLink={{ path: '/team', label: '← Meet the Team' }} />
    </motion.div>
  );
};
